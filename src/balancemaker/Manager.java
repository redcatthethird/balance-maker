...
public class Manager{
    public final ObservableList<Transaction> transactions = FXCollections.observableArrayList();
    public final ObservableList<Buyer> buyers = FXCollections.observableArrayList();
    private final BinaryOperator<Float> sum = (x, y) -> x + y;
    
    public Manager() { transactions.addListener(this::updateBuyers); }
    ...
    private void updateBuyers(javafx.beans.Observable o) {
